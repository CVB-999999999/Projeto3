...
<x-navfoot>
    <x-slot name="content">
        ...
        {{ Breadcrumbs::render('listStudentsDisc', $user->id) }}

        <div class="container mx-auto mb-5 p-4">
            <h1 class="text-center mx-4 mb-4"> Student name: {{ $user->name }}</h1>
            ...
            <div class="row">
                <div class="col-md-8 mx-auto">
                    @if($discs->isNotEmpty())
                        ...
                        @else
                            <form method="post" action="/admin/users/assign" class="mx-auto">
                                @csrf
                                {{-- Selected discipline--}}
                                <label for="selectDisc"> Discipline: </label>
